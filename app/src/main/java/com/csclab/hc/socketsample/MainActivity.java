...
public class MainActivity extends Activity implements android.view.View.OnClickListener{
    ...
    public void onClick(View v) {
        ...
        toSend = new String ("The result from APP is " + num1 +" "+oper+" "+num2+"="+result);
...
*/
                ...
                byte[] sendStrByte2 = new byte[1024];
                System.arraycopy(toSend.getBytes(), 0, sendStrByte2, 0, toSend.length());
                out2.write(sendStrByte2);
